package com.ai.sandbox.twitter.to.kafka.service.listener;

import com.ai.sandbox.config.KafkaConfigData;
import com.ai.sandbox.kafka.avro.model.TwitterAvroModel;
import com.ai.sandbox.kafka.producer.config.service.KafkaProducer;
import com.ai.sandbox.twitter.to.kafka.service.transformer.TwitterStatusToAvroTransformer;
